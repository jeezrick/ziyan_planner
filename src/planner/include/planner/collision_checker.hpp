...
#include "map/footprint_collision_checker.hpp"
...
public:
  ...
  GridCollisionChecker(
    std::shared_ptr<ZiYan_IO::Costmap2DZiYan> costmap,
    unsigned int num_quantizations,
    ZiYan_IO::Info::SharedPtr node);
   ...
   * @return Costmap ros
   */
  std::shared_ptr<ZiYan_IO::Costmap2DZiYan> getCostmapZIYAN() {return costmap_zy_;}
...
protected:
  std::shared_ptr<ZiYan_IO::Costmap2DZiYan> costmap_zy_;
