#ifndef ZIYAN_PLANNER__TYPES_HPP_
#define ZIYAN_PLANNER__TYPES_HPP_
...
struct SmootherParams
{
  ...
  /**
   * @brief Get params from ZiYan parameter
  ...
  void get(std::shared_ptr<ziyan_planner::Info> node)
  {
    ...
    w_data_ = node->smoother.w_data;
    w_smooth_ = node->smoother.w_smooth;
    do_refinement_ = node->smoother.do_refinement;
    refinement_num_ = node->smoother.refinement_num;
  }
